...
import { TokenAmount } from 'harmony-swap-sdk'
      ...
      {!attempting && (
        <ContentWrapper gap="lg">
          <ModalUpper>
            ...
            <CardSection gap="md">
              <RowBetween>
                <TYPE.white fontWeight={500}>Claim ONE Token</TYPE.white>
          ...
          <AutoColumn gap="md" style={{ padding: '1rem', paddingTop: '0' }} justify="center">
            <TYPE.subHeader fontWeight={500}>
              Enter an address to trigger a ONE claim. If the address has any claimable ONE it will be sent to them on
              submission.
            </TYPE.subHeader>
