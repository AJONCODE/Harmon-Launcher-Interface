...
import { TokenAmount, Token, ChainId, Percent, JSBI } from 'harmony-swap-sdk'
...
describe('utils', () => {
  describe('#getEtherscanLink', () => {
    ...
    it('enum', () => {
      expect(getEtherscanLink(ChainId.HARMONY_TESTNET, 'abc', 'address')).toEqual('https://MUMBAI.etherscan.io/address/abc')
    })
  })

  describe('#calculateSlippageAmount', () => {
    it('bounds are correct', () => {
      const tokenAmount = new TokenAmount(new Token(ChainId.HARMONY, AddressZero, 0), '100')
