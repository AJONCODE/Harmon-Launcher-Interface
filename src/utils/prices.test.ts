import { ChainId, JSBI, Pair, Route, Token, TokenAmount, Trade, TradeType } from 'harmony-swap-sdk'
import { computeTradePriceBreakdown } from './prices'

describe('prices', () => {
  const token1 = new Token(ChainId.HARMONY, '0x0000000000000000000000000000000000000001', 18)
  const token2 = new Token(ChainId.HARMONY, '0x0000000000000000000000000000000000000002', 18)
  const token3 = new Token(ChainId.HARMONY, '0x0000000000000000000000000000000000000003', 18)
