...
import { JSBI, TokenAmount, ChainId } from 'harmony-swap-sdk'
  ...
  return (
    <PageWrapper gap="lg" justify="center">
      ...
      <TopSection gap="md">
        <VoteCard>
          ...
          <CardSection>
            <AutoColumn gap="md">
              <RowBetween>
                <TYPE.white fontWeight={600}>ONE Governance</TYPE.white>
              </RowBetween>
              <RowBetween>
                <TYPE.white fontSize={14}>
                ONE tokens represent voting shares in Harmony Launcher governance. You can vote on each proposal yourself or
      ...
      <TYPE.subHeader color="text3">
        A minimum threshhold of 1% of the total ONE supply is required to submit proposals
      </TYPE.subHeader>
    </PageWrapper>
  )
}
